...
/**
 * @ngdoc object
 * @name lbServices.Campus
 * @header lbServices.Campus
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Campus` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Campus#create
         * @methodOf lbServices.Campus
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Campus` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/Campus",
         ...
         */
        "exists": {
          url: urlBase + "/Campus/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Campus#findById
         * @methodOf lbServices.Campus
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/Campus/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Campus#find
         * @methodOf lbServices.Campus
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Campus#findOne
         * @methodOf lbServices.Campus
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/Campus/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Campus#updateAll
         * @methodOf lbServices.Campus
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/Campus/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Campus#deleteById
         * @methodOf lbServices.Campus
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/Campus/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Campus#prototype$updateAttributes
         * @methodOf lbServices.Campus
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Campus#updateOrCreate
         * @methodOf lbServices.Campus
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Campus#destroyById
         * @methodOf lbServices.Campus
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Campus#removeById
         * @methodOf lbServices.Campus
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Campus#modelName
    * @propertyOf lbServices.Campus
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Campus`.
    */
...
module.factory(
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    ...
    /**
    * @ngdoc property
    * @name lbServices.Week#modelName
    * @propertyOf lbServices.Week
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Week`.
    */
...
/**
 * @ngdoc object
 * @name lbServices.PassSession
 * @header lbServices.PassSession
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `PassSession` model.
 *
 * ## Example
 *
 * See
...
module.factory(
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      urlBase + "/PassSessions/:id",
      { 'id': '@id' },
      {

        /**
         * @ngdoc method
         * @name lbServices.PassSession#create
         * @methodOf lbServices.PassSession
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `PassSession` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/PassSessions",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.PassSession#upsert
         * @methodOf lbServices.PassSession
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.PassSession#exists
         * @methodOf lbServices.PassSession
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/PassSessions/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.PassSession#findById
         * @methodOf lbServices.PassSession
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/PassSessions/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.PassSession#find
         * @methodOf lbServices.PassSession
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.PassSession#findOne
         * @methodOf lbServices.PassSession
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/PassSessions/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.PassSession#updateAll
         * @methodOf lbServices.PassSession
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/PassSessions/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.PassSession#deleteById
         * @methodOf lbServices.PassSession
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.PassSession#count
         * @methodOf lbServices.PassSession
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/PassSessions/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.PassSession#prototype$updateAttributes
         * @methodOf lbServices.PassSession
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.PassSession#updateOrCreate
         * @methodOf lbServices.PassSession
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.PassSession#update
         * @methodOf lbServices.PassSession
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.PassSession#destroyById
         * @methodOf lbServices.PassSession
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.PassSession#removeById
         * @methodOf lbServices.PassSession
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.PassSession#modelName
    * @propertyOf lbServices.PassSession
    * @description
    * The name of the model represented by this $resource,
    * i.e. `PassSession`.
    */
    R.modelName = "PassSession";
